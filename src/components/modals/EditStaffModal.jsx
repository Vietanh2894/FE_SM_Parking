...
const EditStaffModal = ({ isOpen, onSave, onClose, staff, isSubmitting = false }) => {
    ...
    const validateForm = () => {
        ...
        // Không cần validate các trường readonly: maNV, username, roleId, chucVu
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            />
                            <p className="text-xs text-gray-500 mt-1">Mã nhân viên không thể thay đổi</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1">Chức vụ không thể thay đổi</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1">Role không thể thay đổi</p>
                        </div>
                    </div>
