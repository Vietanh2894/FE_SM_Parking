...
const EditVehicleTypeModal = ({ isOpen, vehicleType, onSave, onClose, isSubmitting = false }) => {
    ...
    // Don't render if modal is not open or no vehicleType
    ...
    const handleSubmit = (e) => {
        ...
        console.log('Submitting edit vehicle type data:', updatedVehicleType);
        onSave(updatedVehicleType);
    };
            ...
            >
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                        ✏️ Sửa loại xe: {vehicleType.maLoaiXe}
                    </h2>
                    <button 
                        type="button" 
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Nhập tên loại xe (VD: Xe máy)"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                value={formData.moTa}
                                onChange={handleChange}
                                placeholder="Nhập mô tả cho loại xe (tùy chọn)"
                                rows="3"
                                className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none transition-colors duration-200 text-gray-700"
                                disabled={isSubmitting}
                            />
                            <p className="text-xs text-gray-500 mt-1">
                                📝 Mô tả chi tiết về loại xe này
                            </p>
                        </div>
                    </div>
